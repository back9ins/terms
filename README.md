...
In the event that any commission, premium or fee paid or credited to you must be refunded of returned by BackNine to the insurer, BackNine is authorized, but not obligated, to make payment on your behalf and will be reimbursed for this payment in full by you within thirty (30) days of the date of such payment. If such payment is not made by you, then BackNine is authorized to debit any commissions which may be due to you until such obligation has been fulfilled. You will also reimburse BackNine for any and all costs and expenses (including reasonable attorney’s fees) incurred by BackNine in collection of any such sums from you.
...
BackNine may offer a commission payment and accounting service known as “BackNine Pay.” BackNine Pay is a commission and payment administration service; it is not payroll and does not convert any independent contractor relationship into an employment relationship.

If you or your agency elects, is configured for, or otherwise uses BackNine Pay, you authorize BackNine to receive commissions, overrides, bonuses, fees, or other compensation from insurance carriers or other payors on your behalf or on behalf of your agency or hierarchy, and to distribute such amounts according to the commission schedules, hierarchy, payment instructions, assignments, splits, or other records maintained by BackNine.

BackNine Pay may be used to support commission arrangements including, but not limited to, agencies with multiple levels of managers, recruiters, or sub-agencies, and agencies that request consolidated commission accounting or downstream commission distribution.

BackNine’s obligation to pay any commission or other compensation through BackNine Pay is limited to amounts actually received by BackNine and determined by BackNine to be payable under the applicable carrier payment, commission schedule, hierarchy, assignment, split, or other applicable arrangement. BackNine does not guarantee the timing, amount, or availability of any commission payment from any insurance carrier or third-party payor.

You are responsible for ensuring that all payment instructions, tax information, banking information, hierarchy information, commission assignments, and split arrangements provided to BackNine are accurate and complete. BackNine may rely on the information available in its systems when calculating or distributing payments.

If any commission, override, bonus, fee, advance, premium, or other amount paid or credited to you, your downline, your upline, your agency, or any person or entity in your commission hierarchy is later charged back, reversed, refunded, returned, or otherwise determined not to be payable, BackNine may seek reimbursement from, and offset amounts against, any party that received or benefited from the payment, including the writing agent, the agent or entity to whom commissions were assigned, any upline agent, any agency, and any person or entity receiving overrides or other compensation related to the transaction.

If a downline agent or other payee is responsible for a chargeback or repayment obligation and does not timely repay the amount owed, BackNine may recover the unpaid amount from the agent or entity to whom commissions were assigned, the applicable upline agent, the applicable agency, or any other person or entity that received overrides or other compensation related to the transaction. BackNine may recover such amounts by invoice, direct repayment request, offset against current or future commissions, offsets against overrides, reversal of prior payments, debit from available balances, or any other lawful collection method.

BackNine may delay, withhold, offset, reverse, or adjust payments as reasonably necessary to address missing information, suspected errors, carrier chargebacks, returned premiums, refunds, negative balances, compliance concerns, payment disputes, or other issues affecting payment accuracy.

BackNine Pay does not create an employment relationship, payroll relationship, wage arrangement, partnership, joint venture, franchise, or agency relationship between BackNine and any producer, agent, agency, upline, downline, assignee, or other payee. Unless expressly agreed otherwise in writing, all such parties are independent contractors or independent business entities, and payments made through BackNine Pay are intended to be non-employee compensation, commission, override, fee, or other 1099-reportable compensation, as applicable. No payee is entitled to employee wages, salary, overtime, benefits, unemployment insurance, workers’ compensation, payroll tax withholding, or other employee rights or benefits from BackNine by virtue of using BackNine Pay.

BackNine Pay does not alter the terms of any carrier contract, appointment, commission schedule, agency agreement, producer agreement, or other agreement unless expressly stated in writing. Use of BackNine Pay does not guarantee that a carrier will issue, approve, place, or pay compensation on any policy or transaction.

You agree that BackNine may maintain records of commissions received, amounts allocated, amounts paid, payment instructions, adjustments, chargebacks, and related accounting information in connection with BackNine Pay. You further agree that BackNine may provide payment reports, statements, tax documentation, or other payment-related information as required by law, contract, or ordinary business operations.
